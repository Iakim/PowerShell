...
#EXPORT
$b = "<center><font face='Calibri' size='5'>Relatório de Usuários do Active Directory </font></center><br>"
Get-ADUser -Filter * | select Name, Enabled |Sort Enabled, name| ConvertTo-Html -head $a -body $b | Out-File "C:\Get-ADUser.html"