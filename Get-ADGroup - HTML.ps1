...
#EXPORT
$b = "<center><font face='Calibri' size='5'>Relatório de Grupos do Active Directory </font></center><br>"
Get-ADGroup -Filter * | select Name, GroupCategory |Sort GroupCategory, Name| ConvertTo-Html -head $a -body $b | Out-File "C:\Get-ADGroup.html"